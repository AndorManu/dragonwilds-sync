...
_ICONS = {
    ...
    "horseshoe": (
        ...
        '<line x1="4.5" y1="21" x2="8.5" y2="21"/>'
        '<line x1="15.5" y1="21" x2="19.5" y2="21"/>'
    ),
    "gem": (
        '<path d="M7 3.5h10l3.5 5.5L12 20.5 3.5 9z"/>'
        '<path d="M3.5 9h17"/><path d="M12 20.5 8.5 9 12 3.5 15.5 9z"/>'
    ),
    "gift": (
    ...
    "scroll": (
        '<path d="M7 4h11a2 2 0 0 1 2 2v12a2 2 0 0 0 2 2H9a2 2 0 0 1-2-2z"/>'
